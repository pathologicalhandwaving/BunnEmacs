...
(use-package org-ref
    ...
    (setq
         ...
         org-ref-default-bibliography (list "~/Librarian/Bibliography/default.bib")
         org-ref-bibliography-notes "~/Librarian/Annotations/annotations.org"
         org-ref-note-title-format "* NOTES %y - %t\n :PROPERTIES:\n  :CITEKEY: %k\n  :NOTES_DOCUMENT: %F\n :AUTHOR: %9a\n  :JOURNAL: %j\n  :YEAR: %y\n  :VOLUME: %v\n  :PAGES: %p\n  :DOI: %D\n  :URL: %U\n :END:\n\n"
         org-ref-notes-directory "~/Librarian/Annotations"
