...
#+begin_src emacs-lisp
(require 'org-journal)
(setq org-journal-dir "~/OrgDB/Logs")
...
(defun org-journal-file-header-func (time)
  "Function to create journal header"
  (concat
   (pcase org-journal-file-type
     ('daily "#+TITLE: Daily Log\n#+CATEGORY: Logs\n#+STARTUP: showeverything")
     ('weekly "#+TITLE: Weekly Log\n#+CATEGORY: Logs\n#+STARTUP: folded")
     ('monthly "#+TITLE: Monthly Log\n#+CATEGORY: Logs\n#+STARTUP: folded")
     ('yearly "#+TITLE: Yearly Log\n#+CATEGORY: Logs\n#+STARTUP: folded"))))
...
(use-package org-journal-list
        :ensure t
        :config
        (setq org-journal-list-default-directory "~/OrgDB/Logs/"))
#+end_src
