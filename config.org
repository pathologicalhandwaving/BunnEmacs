...
(setq org-emphasis-alist
  '(("*" bold :foreground "red" :weight bold )
    ...
    ("_" underline :foreground "yellow" :weight bold (:underline t :color "yellow"))
    ("=" org-verbatim "<code>" "</code>" :foreground "green" verbatim)
    ("~" org-code "<code>" "</code>" :foreground "orange" verbatim)
    ("+" strikethrough :foreground "blue" (:strike-through t :color "blue"))))
#+end_src
