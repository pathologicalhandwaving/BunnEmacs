...
(add-to-list 'org-emphasis-alist
             '("*" (:foreground "#BF616A" :weight bold)
               "+" (:foreground "#81A1C1" :weight regular (:strike-through t))
               "_" (:foreground "#D08770" :weight regular (:underline t))
               "=" (:foreground "#A3BE8C" :weight regular (org-code verbatim))
               "~" (:foreground "#EBCB8B" :weight regular (org-verbatim verbatim))
               "/" (:foreground "#B48EAD" :weight regular :slant italic)))
#+end_src
...
#+begin_src emacs-lisp
(defun bun-modify-org-done-face ()
  (setq org-fontify-done-headline t)
  (set-face-attribute 'org-done nil
                      :strike-through "#D8DEE9"
                      :foreground "#D8DEE9"
                      :slant italic
                      :weight light)
  (set-face-attribute 'org-headline-done nil
                      ...
                      :slant italic
                      :weight light))
(add-hook 'org-mode-hook 'bun-modify-org-done-face)
(setq org-fontify-done-headline t)
