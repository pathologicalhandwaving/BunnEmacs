...
*BunnEmacs* is a MacOS centric emacs distribution, developed on MacOS Catalina 10.15.6 using the development version of *Emacs* 28 HEAD (see README for installation steps).
